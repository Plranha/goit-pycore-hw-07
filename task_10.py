...
oleh_record.add_phone('3809964412')
oleh_record.add_phone('3809876645')
addressbook.add_record(oleh_record)
oleh_record.add_birthday('09091996')

found_phone = oleh_record.find_phone('3809964412')
print(found_phone)
print(oleh_record.show_birthday)
